...
if (isset($_REQUEST["long"])) {
	...
	$long_url = addslashes( $_REQUEST['long'] );	// longurl
	$clicks	  = addslashes( $_REQUEST['click'] );	// click
	...
	$lines[1] = "#" . $first . "\n";
	$short_url = $first;
	$array_line = "'$short_url' => array( 'u'=> '$long_url', 'c'=>'$clicks' ),  \n";
	...
	Enter the url to shorten:<br><input type="text" name="long" /> <br/>
	Max clicks (-1 infinite):<br><input type="text" name="click" value="-1" /> <br/>
	<input type="submit" />
	</form>
	</center>
	<?
